 ...
 *      Figuring out how to make this small scale. Also trying to figure out what was wrong with 
...
const double GEO = 35786000.0;//42164000.0;
const double EARTH_RADIUS = 6371e3;
const double GEO_VELOCITY = 3100.0;
const double TIME_DILATION = 24 * 60;
const double TIME_PER_FRAME = TIME_DILATION / 10.5; //Wonky hard-coded value. Don't know why it's being weird.
...
void callBack(const Interface* pUI, void* p)
{
   ...
   pDemo->ptGPS.setMeters(pDemo->orbitalRadius * sin(pDemo->angleShip), pDemo->orbitalRadius * cos(pDemo->angleShip));
